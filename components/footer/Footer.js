                ...
                <div className="container">
                    <div className="grid grid-cols-16 pt-24">
                        <div className=" col-start-2 col-span-14">
                            ...
                            <div className="pb-9 flex flex-col sm:flex-row justify-between w-full sm:items-center">
                                <Link href="/" className="">
                                    <Image
                                ...
                                <div className="flex flex-row flex-wrap">
                                    <Link href="/" className="content-primary mb-6 mr-6 sm:mr-12">
                                        <p>HOME</p>
                                    </Link>
                                    <Link href="/sobre" className="content-primary mb-6 mr-6 sm:mr-12">
                                        <p>SOBRE</p>
                                    </Link>
                                    <Link href="/contato" className="content-primary">
                                        <p>CONTATO</p>
                                    </Link>
                                </div>
                            </div>
