        ...
        <section className='bg-bg-color-0 py-40' id="contact-form">
            <div className='container'>
                <div className='grid grid-cols-16'>
                    ...
                    <div className='col-span-16 lg:col-start-7 lg:col-span-full rounded-[28px] bg-gradient-radial px-6 py-10 lg:px-12 lg:py-16 border border-white shadow-sm min-h-[933px] '>
                        {isSubmitting ? (
                            <Animation className="h-full">
                                <div className='flex flex-col justify-center items-center text-center h-full'>
                                    <div className='px-[20px] py-[8px] rounded-full bg-navbar-text w-fit mb-6 '>
                                        <Image height={24} width={24} alt='' src="/assets/icons/general/file-check-02.svg" />
                                    </div>
                                    <h1 className=' content-primary text-xl lg:text-xl pb-6'>Dados enviados com sucesso!</h1>
                                    <p className='content-secondary text-base sm:text-lg pb-14'>Já recebemos suas informações. Aguarde o contato de nossos especialistas com sua cotação atualizada.</p>
                                </div>
                                <p className='content-secondary text-base pb-14 text-center'>Precisa de mais informações? <Link href="/contato" className='underline text-text-accent hover:text-text-accent-hover duration-500 ease-in transition-all hover:duration-500 hover:ease-in hover:transition-all'>Entrar em contato</Link></p>
                            </Animation>
                        ) : (
                            <>
